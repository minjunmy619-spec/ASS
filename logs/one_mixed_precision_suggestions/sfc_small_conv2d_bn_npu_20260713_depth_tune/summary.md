...
- `qconfig_depth_front_10_int16.json`: AMPQ-style depth front split at 0.1 (8 layers)
- `qconfig_depth_back_10_int16.json`: AMPQ-style depth back split at 0.1 (22 layers)
- `qconfig_depth_front_15_int16.json`: AMPQ-style depth front split at 0.15 (12 layers)
- `qconfig_depth_back_15_int16.json`: AMPQ-style depth back split at 0.15 (27 layers)
- `qconfig_depth_front_20_int16.json`: AMPQ-style depth front split at 0.2 (17 layers)
- `qconfig_depth_back_20_int16.json`: AMPQ-style depth back split at 0.2 (33 layers)
