...
_EXPORTS = {
    ...
    "SFCSmallPyramidDWBNNPUCore": f"{_MODEL}.sfc_small_pyramid_dw_bn_npu",
    "SFCSmallPyramidDWBNNPUModel": f"{_MODEL}.sfc_small_pyramid_dw_bn_npu",
    "SFCSmallSameBandDWBNNPUCore": f"{_MODEL}.sfc_small_sameband_dw_bn_npu",
    "SFCSmallSameBandDWBNNPUModel": f"{_MODEL}.sfc_small_sameband_dw_bn_npu",
    "SFCSmallMacaronConv2DBNNPUCore": f"{_MODEL}.sfc_small_macaron_conv2d_bn_npu",
    "SFCSmallMacaronConv2DBNNPUModel": f"{_MODEL}.sfc_small_macaron_conv2d_bn_npu",
    "SFCSmallMacaronConv2DCLNNPUCore": f"{_MODEL}.sfc_small_macaron_conv2d_cln_npu",
    "SFCSmallMacaronConv2DCLNNPUModel": f"{_MODEL}.sfc_small_macaron_conv2d_cln_npu",
    "SFCSmallMacaronConv2DCLNLiteNPUCore": f"{_MODEL}.sfc_small_macaron_conv2d_cln_lite_npu",
